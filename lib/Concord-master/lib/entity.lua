...
local function entityTostring(self) --tostring functionality
   return "Entity "..tostring(self.name) or "Entity"
end

local Entity = {}
Entity.__index = Entity
Entity.__tostring = entityTostring --tostring metamethod
