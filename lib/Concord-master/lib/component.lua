...
local function entityTostringClass(self)
   return "Component Class "..tostring(self.name) or "Component Class"
end
local function entityTostring(self)
   return "Component "..tostring(self.name) or "Component"
end

local Component = {}
Component.__index = Component
Component.__tostring = entityTostring
